...
iris= User.create(name: "Iris", city: "Seattle", username: "iris", password: "1", password_digest: "test")
ellyn= User.create(name: "Ellyn", city: "Denver", username: "ellyn", password: "1", password_digest: "test")
nick= User.create(name: "Nick", city: "Indianapolis", username: "nick", password: "1", password_digest: "test")
brittan= User.create(name: "Brittan", city: "NYC", username: "brittan", password: "1", password_digest: "test")
